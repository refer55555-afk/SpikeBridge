// Lucide Icons (ISC / MIT). License: operator/assets/LUCIDE-LICENSE.txt.
const iconPaths={"info":"<circle cx=\"12\" cy=\"12\" r=\"10\" />\n  <path d=\"M12 16v-4\" />\n  <path d=\"M12 8h.01\" />","list-todo":"<path d=\"M13 5h8\" />\n  <path d=\"M13 12h8\" />\n  <path d=\"M13 19h8\" />\n  <path d=\"m3 17 2 2 4-4\" />\n  <rect x=\"3\" y=\"4\" width=\"6\" height=\"6\" rx=\"1\" />","sun-moon":"<path d=\"M12 2v2\" />\n  <path d=\"M14.837 16.385a6 6 0 1 1-7.223-7.222c.624-.147.97.66.715 1.248a4 4 0 0 0 5.26 5.259c.589-.255 1.396.09 1.248.715\" />\n  <path d=\"M16 12a4 4 0 0 0-4-4\" />\n  <path d=\"m19 5-1.256 1.256\" />\n  <path d=\"M20 12h2\" />","search":"<path d=\"m21 21-4.34-4.34\" />\n  <circle cx=\"11\" cy=\"11\" r=\"8\" />","workflow":"<rect width=\"8\" height=\"8\" x=\"3\" y=\"3\" rx=\"2\" />\n  <path d=\"M7 11v4a2 2 0 0 0 2 2h4\" />\n  <rect width=\"8\" height=\"8\" x=\"13\" y=\"13\" rx=\"2\" />","chevron-down":"<path d=\"m6 9 6 6 6-6\" />","arrow-up-right":"<path d=\"M7 7h10v10\" />\n  <path d=\"M7 17 17 7\" />","cpu":"<path d=\"M12 20v2\" />\n  <path d=\"M12 2v2\" />\n  <path d=\"M17 20v2\" />\n  <path d=\"M17 2v2\" />\n  <path d=\"M2 12h2\" />\n  <path d=\"M2 17h2\" />\n  <path d=\"M2 7h2\" />\n  <path d=\"M20 12h2\" />\n  <path d=\"M20 17h2\" />\n  <path d=\"M20 7h2\" />\n  <path d=\"M7 20v2\" />\n  <path d=\"M7 2v2\" />\n  <rect x=\"4\" y=\"4\" width=\"16\" height=\"16\" rx=\"2\" />\n  <rect x=\"8\" y=\"8\" width=\"8\" height=\"8\" rx=\"1\" />","cable":"<path d=\"M17 19a1 1 0 0 1-1-1v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a1 1 0 0 1-1 1z\" />\n  <path d=\"M17 21v-2\" />\n  <path d=\"M19 14V6.5a1 1 0 0 0-7 0v11a1 1 0 0 1-7 0V10\" />\n  <path d=\"M21 21v-2\" />\n  <path d=\"M3 5V3\" />\n  <path d=\"M4 10a2 2 0 0 1-2-2V6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2a2 2 0 0 1-2 2z\" />\n  <path d=\"M7 5V3\" />","sliders-horizontal":"<path d=\"M10 5H3\" />\n  <path d=\"M12 19H3\" />\n  <path d=\"M14 3v4\" />\n  <path d=\"M16 17v4\" />\n  <path d=\"M21 12h-9\" />\n  <path d=\"M21 19h-5\" />\n  <path d=\"M21 5h-7\" />\n  <path d=\"M8 10v4\" />\n  <path d=\"M8 12H3\" />","chart-no-axes-column":"<path d=\"M5 21v-6\" />\n  <path d=\"M12 21V3\" />\n  <path d=\"M19 21V9\" />","monitor":"<rect width=\"20\" height=\"14\" x=\"2\" y=\"3\" rx=\"2\" />\n  <line x1=\"8\" x2=\"16\" y1=\"21\" y2=\"21\" />\n  <line x1=\"12\" x2=\"12\" y1=\"17\" y2=\"21\" />","database":"<ellipse cx=\"12\" cy=\"5\" rx=\"9\" ry=\"3\" />\n  <path d=\"M3 5V19A9 3 0 0 0 21 19V5\" />\n  <path d=\"M3 12A9 3 0 0 0 21 12\" />","panel-left":"<rect width=\"18\" height=\"18\" x=\"3\" y=\"3\" rx=\"2\" />\n  <path d=\"M9 3v18\" />","circle-check":"<circle cx=\"12\" cy=\"12\" r=\"10\" />\n  <path d=\"m16 9-5.5 5.5L8 12\" />","refresh-cw":"<path d=\"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8\" />\n  <path d=\"M21 3v5h-5\" />\n  <path d=\"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16\" />\n  <path d=\"M8 16H3v5\" />","shield-check":"<path d=\"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z\" />\n  <path d=\"m9 12 2 2 4-4\" />","scroll-text":"<path d=\"M15 12h-5\" />\n  <path d=\"M15 8h-5\" />\n  <path d=\"M19 17V5a2 2 0 0 0-2-2H4\" />\n  <path d=\"M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v2a1 1 0 0 0 1 1h3\" />","layout-dashboard":"<rect width=\"7\" height=\"9\" x=\"3\" y=\"3\" rx=\"1\" />\n  <rect width=\"7\" height=\"5\" x=\"14\" y=\"3\" rx=\"1\" />\n  <rect width=\"7\" height=\"9\" x=\"14\" y=\"12\" rx=\"1\" />\n  <rect width=\"7\" height=\"5\" x=\"3\" y=\"16\" rx=\"1\" />"};
function icon(name){return '<svg class="ui-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false">'+(iconPaths[name]||iconPaths.info)+'</svg>';}
const viewIcons={overview:'layout-dashboard',tasks:'list-todo',channels:'cable',usage:'chart-no-axes-column',concurrency:'sliders-horizontal',providers:'cpu',profile:'workflow',appearance:'sun-moon',memory:'database',recovery:'shield-check',logs:'scroll-text',advanced:'info'};
...
function pageHead(title,desc,actions=''){return `<div class="page-head"><div><h1>${e(title)}</h1><p>${e(desc)}</p></div>${actions?`<div class="actions">${actions}</div>`:''}</div>`;}
...
function taskRowActions(t,compact=false){
  if(compact)return `<div class="task-actions"><button ${t.live&&t.pendingApproval?'class="primary"':''} data-task="${e(t.ref)}" data-provider="${e(t.provider)}">${t.live&&t.pendingApproval?'处理':'详情'}</button></div>`;
...
function taskTable(rows,compact=false){
  ...
  return '<div class="table-wrap"><table class="task-table"><colgroup><col class="col-task"><col class="col-provider"><col class="col-time"><col class="col-action"></colgroup><thead><tr><th>任务 / 最新进展</th><th>执行器</th><th>状态</th><th><span class="sr-only">操作</span></th></tr></thead><tbody>'+shown.map(t=>`<tr data-key="${e(t.provider+':'+t.ref)}"><td><div class="task-title" title="${e(t.description||t.title)}">${e(t.title||'未命名任务')}</div><div class="sub">${e(t.model||'模型未提供')} · ${e(t.cwd||t.project||'项目未提供')}</div>${t.pendingApproval?'<div class="request-hint">'+e(requestExplanation(t).title)+'</div>':''}</td><td>${e(names[t.provider]||t.provider||'未提供')}<div class="sub">${t.live?'当前实例':'历史待核验'}</div></td><td>${pill(t.status)}<div class="sub">${e(when(t.updatedAt))}</div></td><td>${taskRowActions(t,compact)}</td></tr>`).join('')+'</tbody></table></div>'+(!compact?`<div class="pagination"><span>共 ${total} 条 · 每页最多 50 条</span><div><button data-task-page="-1" ${taskPage===0?'disabled':''}>上一页</button><span>${taskPage+1} / ${pages}</span><button data-task-page="1" ${taskPage>=pages-1?'disabled':''}>下一页</button></div></div>`:'');
}
...
function channelHealthSummary(){
  const channels=state.channels||[],good=channels.filter(c=>c.connected===true&&!c.recovering).length;
  const bad=channels.filter(c=>c.connected===false&&!c.recovering).length,unknown=channels.filter(c=>typeof c.connected!=='boolean'&&!c.recovering).length,recovering=channels.filter(c=>c.recovering).length;
  const notes=[bad?bad+' 条连接异常':'',recovering?recovering+' 条恢复中':'',unknown?unknown+' 条待核验':''].filter(Boolean);
  return '<div class="channel-summary '+(bad||unknown||recovering||!channels.length?'warning-text':'')+'">'+(channels.length?good+' / '+channels.length+' 条通道正常':'通道状态待核验')+(notes.length?' · '+notes.join(' · '):'')+'</div>';
}
...
function overview(){
  ...
  return pageHead('工作总览','任务、连接与待处理事项，一处掌握。', '<span class="workspace-label">'+icon('monitor')+'本机工作站</span>')+
  `<div class="health-line"><div><div class="title ${h.healthy===true?'good-text':h.healthy===false?'bad-text':''}"><span class="dot ${h.healthy===true?'good':h.healthy===false?'bad':''}"></span>${h.healthy===true?'Bridge 服务正常':h.healthy===false?'Bridge 不可达':'Bridge 状态未知'}</div><div class="detail">127.0.0.1:7690 · ${e(h.version||'版本未提供')}</div></div><div class="split">${channelHealthSummary()}<div class="detail">Bridge A / B 独立连接</div></div></div>
  <div class="overview-work"><div class="overview-main"><section class="section"><div class="section-head"><div><h2>${current.length?"当前任务":"最近任务"}</h2><p>${current.length?'运行与待处理任务实时更新。':'当前没有运行任务，以下是最近 5 条记录。'}</p></div><button class="text-button" data-nav="tasks">查看全部任务</button></div><div class="counts-inline"><span><b>${number(counts?.active)}</b>运行中</span><span><b>${number(counts?.awaitingApproval)}</b>需要处理</span><span><b>${number(counts?.uncertain)}</b>状态未知</span></div>${taskTable(mainRows,true)}</section>
...
function render(patch=false){
  ...
  const nav=navGroups.map((g,i)=>{const buttons=g.items.map(id=>`<button data-nav="${id}" ${id===view&&!search?'aria-current="page"':''}>${icon(viewIcons[id])}<span class="nav-text">${e(views.find(v=>v[0]===id)[1])}</span>${id==='tasks'?'<span class="nav-count">'+(state.controlConnected?number((state.tasks||[]).filter(t=>t.live&&t.pendingApproval).length):'未知')+'</span>':''}</button>`).join('');return g.collapse?`<details data-key="nav-${i}" ${g.items.includes(view)?'open':''}><summary>${g.title}${icon("chevron-down")}</summary>${buttons}</details>`:`<div class="nav-group" data-key="nav-${i}"><div class="nav-label">${g.title}</div>${buttons}</div>`;}).join('');
  patchHTML($('#nav'),nav);
...
async function navigate(id){
  ...
  search='';$('#search').value='';render();$('#main').scrollTo({top:0,behavior:'instant'});$('#main').focus({preventScroll:true});
...
function setNavigation(open){$('.shell').classList.toggle('nav-collapsed',!open);$('#toggle-navigation').innerHTML=icon('panel-left');$('#toggle-navigation').setAttribute('aria-label',open?'收起导航':'展开导航');$('#toggle-navigation').title=open?'收起导航':'展开导航';$('#toggle-navigation').setAttribute('aria-expanded',String(open));}
